...
# Usage: first download COCO val2017 images and instances_val2017.json via Kaggle CLI
# then run: python download_coco_subset.py --coco_annotations path/to/instances_val2017.json --images_dir path/to/val2017 --out_dir datasets/real_coco_subset
